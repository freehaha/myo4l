...
(function() {
  var CONN_CONNECTED, CONN_CONNECTING, CONN_DISCONNECTED, Emg, EventEmitter, Imu, LOCKING_NONE, LOCKING_STANDARD, Myo, Pose, async, command, constants, noble,
  ...
  Myo = (function(_super) {
    ...
    function Myo(devName) {
      ...
      this.onDiscover = __bind(this.onDiscover, this);
      ...
      this._inited = false;
      this.dev = null;
      this.connection = CONN_DISCONNECTED;
      this.services = {};
      this.chars = {};
      this.fVersion = null;
    ...
    Myo.prototype.disconnect = function() {
      if (this.connection !== CONN_DISCONNECTED) {
    ...
    Myo.prototype.readFirmwareVersion = function() {
          ...
          return c.read(function(err, version) {
            ...
            return async.parallel([
              ...
              return _this.setMode(command.emg.DISABLE, command.imu.ENABLE, command.classifier.ENABLE, function(err) {
                ...
                return _this.connection = CONN_CONNECTED;
              });
            });
          });
        };
    ...
    Myo.prototype.readNecessaryInfo = function() {
      return this.readFirmwareVersion();
    };
    ...
    Myo.prototype.initMyo = function() {
      ...
      return this.dev.connect(function(err) {
        if (err) {
    ...
    Myo.prototype.onDiscover = function(peri) {
      var len;
      if (this.connection !== CONN_CONNECTING) {
        noble.stopScanning();
        return;
      }
      if (this.connection !== CONN_CONNECTING) {
      ...
      if (peri.advertisement.localName.substring(0, len - 1) === this.devName) {
        this.dev = peri;
        this.initMyo();
        noble.stopScanning();
      }
    ...
    Myo.prototype.connect = function() {
      ...
      this.connection = CONN_CONNECTING;
